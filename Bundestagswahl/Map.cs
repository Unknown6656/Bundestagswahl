...
public class Map
{
    public static Map SmallMap { get; } = new([
        ...
        "-----8888888888888888888888DDDDDD333322233333----",
    ...
    public static Map MediumMap { get; } = new([
        ...
        "---------8888888888888888888888888888DDDDDDDDD3333332222333333-------",
        "------88888888888888888888888888888888DDDDDDDD333333222223333333-----",
    ...
    public static Map LargeMap { get; } = new([
        ...
        "---------------8888888888888888888888888888888888888DDDDDDDDDDDDDD33333333222233333333-----------",
        "-----------888888888888888888888888888888888888888888DDDDDDDDDDDD333333332222223333333333--------",
        "--------------888888888888889998889888888888888888888DDDDDDDDDDDDDD333333222222233333333333------",
    ...
    public (int X, int Y)[] this[State state]
    {
        get
        {
            if (_states.TryGetValue(state, out List<int>? positions))
            {
